 ...
 * @Created by Kangaroo
 */
public interface DyOpenConfigStorage {
...
//    void updateAuthorizerAccessToken(String appId, WxOpenAuthorizerAccessToken authorizerAccessToken);
     ...
     */
    void setDyOpenInfo(String componentAppId, String componentAppSecret, String componentToken, String componentAesKey);
